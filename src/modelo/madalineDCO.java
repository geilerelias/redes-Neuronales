 ...
 * @author eldoc
 */
public class madalineDCO extends red implements Runnable{
    ...
    public madalineDCO(int m, int o, int n, int patrones, double[][] x, double[][] yd, int epoch, double lr, double goal, String funcionActivacionEntrada, String funcionActivacionSalida, String algoritmo,double []u,double [][]w,double []us,double [][]ws,String nombre) {
