 ...
 * @author eldoc
 */
public class madalineTCO extends red{
    ...
    public madalineTCO(int m, int o, int n, int patrones, double[][] x, double[][] yd, int epoch, double lr, double goal, String funcionActivacionEntrada, String funcionActivacionSalida, String algoritmo,String nombre) {
