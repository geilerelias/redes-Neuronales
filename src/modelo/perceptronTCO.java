 ...
 * @author eldoc
 */
public class perceptronTCO extends red {
    ...
    public perceptronTCO() {
    }

    public perceptronTCO(int m, int o, int n, int patrones, double[][] x, double[][] yd, int epoch, double lr, double goal, String funcionActivacionEntrada, String funcionActivacionSalida, String algoritmo,String nombre) {
