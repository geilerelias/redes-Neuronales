...
import efectos.ElevationEffect;
...
class CustomUI extends BasicComboBoxUI {
    ...
    private ImageIcon espacio = new ImageIcon(getClass().getResource("/vista/images/espacio.png"));
    ...
    protected JButton createArrowButton() {
        ...
        button.setIcon(new ImageIcon(getClass().getResource("/vista/images/icons8_Sine_24px.png")));
        return button;
    }*/
